...
;
; capscr: PageReinstall registration disabled — manual upgrade installs
; should overwrite in place, never prompt "uninstall before installing".
; The functions below stay defined so existing call sites (PageLeaveReinstall
; from passive mode) continue to compile, just unreferenced.
